...
int TestNoPrior(ImageType::Pointer inputImage)
{
  ...
  if (!itk::Math::FloatAlmostEqual(filter->GetMaxValueOfRGB() , 255))
    {
...
int itkVoronoiSegmentationRGBImageFilterTest(int, char* [] )
{
  ...
  if (!itk::Math::FloatAlmostEqual(meanPercentErrorOut[0] , 0.1) ||
      !itk::Math::FloatAlmostEqual(meanPercentErrorOut[1] , 0.1) ||
      !itk::Math::FloatAlmostEqual(meanPercentErrorOut[2] , 0.1) ||
      !itk::Math::FloatAlmostEqual(meanPercentErrorOut[3] , 0.1) ||
      !itk::Math::FloatAlmostEqual(meanPercentErrorOut[4] , 0.1) ||
      !itk::Math::FloatAlmostEqual(meanPercentErrorOut[5] , 0.1))
    {
  ...
  if (!itk::Math::FloatAlmostEqual(stdPercentErrorOut[0] , 0.1) ||
      !itk::Math::FloatAlmostEqual(stdPercentErrorOut[1] , 0.1) ||
      !itk::Math::FloatAlmostEqual(stdPercentErrorOut[2] , 0.1) ||
      !itk::Math::FloatAlmostEqual(stdPercentErrorOut[3] , 0.1) ||
      !itk::Math::FloatAlmostEqual(stdPercentErrorOut[4] , 0.1) ||
      !itk::Math::FloatAlmostEqual(stdPercentErrorOut[5] , 0.1))
    {
