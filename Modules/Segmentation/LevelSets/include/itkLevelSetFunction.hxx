                ...
                const FloatOffsetType & offset)
{
  ...
  if ( !itk::Math::FloatAlmostEqual(m_CurvatureWeight , ZERO) )
    {
  ...
  //
  if ( !itk::Math::FloatAlmostEqual(m_AdvectionWeight , ZERO) )
    {
  ...
  if ( !itk::Math::FloatAlmostEqual(m_PropagationWeight , ZERO) )
    {
  ...
  if ( !itk::Math::FloatAlmostEqual(m_LaplacianSmoothingWeight , ZERO) )
    {
    laplacian = ZERO;
