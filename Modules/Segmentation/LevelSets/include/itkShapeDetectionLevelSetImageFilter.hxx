...
::GenerateData()
{
  ...
  if ( this->GetSegmentationFunction()
       && !itk::Math::FloatAlmostEqual(this->GetSegmentationFunction()->GetCurvatureWeight() , 0)
       && itk::Math::FloatAlmostEqual(this->GetSegmentationFunction()->GetPropagationWeight() , 0) )
    {
