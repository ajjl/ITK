...
::GenerateData()
{
  ...
  if ( !itk::Math::FloatAlmostEqual(this->GetSegmentationFunction()->GetPropagationWeight() , 0) )
    {
    m_SegmentationFunction->AllocateSpeedImage();
    m_SegmentationFunction->CalculateSpeedImage();
    }
  if ( !itk::Math::FloatAlmostEqual(this->GetSegmentationFunction()->GetAdvectionWeight() , 0) )
    {
