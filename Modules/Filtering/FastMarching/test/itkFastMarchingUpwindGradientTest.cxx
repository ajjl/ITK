...
// marcher->DebugOn();
  ...
  for (; !iterator.IsAtEnd(); ++iterator )
    ...
    if (itk::Math::FloatAlmostEqual(distance , 0))
      {
      continue;
      }
  ...
  if( !itk::Math::FloatAlmostEqual(marcher->GetStoppingValue() , stoppingValue) )
    {
  ...
  if( !itk::Math::FloatAlmostEqual(smallestReachingTime , marcher->GetTargetValue()) )
    {
  ...
  if( !itk::Math::FloatAlmostEqual(largestReachingTime , marcher->GetTargetValue()) )
    {
  ...
  if( !itk::Math::FloatAlmostEqual(marcher->GetStoppingValue() , newStoppingValue) )
    {
