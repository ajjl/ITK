...
int itkShapeLabelObjectAccessorsTest1(int argc, char * argv[])
{
  ...
  for (unsigned int n = 0; n < labelMap->GetNumberOfLabelObjects(); n++)
    ...
    if (!itk::Math::FloatAlmostEqual(labelCopy->GetPhysicalSize() , labelObject->GetPhysicalSize()))
      {
    ...
    if (!itk::Math::FloatAlmostEqual(labelCopy->GetPerimeterOnBorder() , labelObject->GetPerimeterOnBorder()))
      {
      std::cout << "CopyAttributeFrom failed for attribute " << "PerimeterOnBorder" << std::endl;
      status = EXIT_FAILURE;
      }
    if (!itk::Math::FloatAlmostEqual(labelCopy->GetFeretDiameter() , labelObject->GetFeretDiameter()))
      {
    ...
    if (!itk::Math::FloatAlmostEqual(labelCopy->GetElongation() , labelObject->GetElongation()))
      {
      std::cout << "CopyAttributeFrom failed for attribute " << "Elongation" << std::endl;
      status = EXIT_FAILURE;
      }
    if (!itk::Math::FloatAlmostEqual(labelCopy->GetPerimeter() , labelObject->GetPerimeter()))
      {
      std::cout << "CopyAttributeFrom failed for attribute " << "Perimeter" << std::endl;
      status = EXIT_FAILURE;
      }
    if (!itk::Math::FloatAlmostEqual(labelCopy->GetRoundness() , labelObject->GetRoundness()))
      {
      std::cout << "CopyAttributeFrom failed for attribute " << "Roundness" << std::endl;
      status = EXIT_FAILURE;
      }
    if (!itk::Math::FloatAlmostEqual(labelCopy->GetEquivalentSphericalRadius() , labelObject->GetEquivalentSphericalRadius()))
      {
      std::cout << "CopyAttributeFrom failed for attribute " << "EquivalentSphericalRadius" << std::endl;
      status = EXIT_FAILURE;
      }
    if (!itk::Math::FloatAlmostEqual(labelCopy->GetEquivalentSphericalPerimeter() , labelObject->GetEquivalentSphericalPerimeter()))
      {
    ...
    if (!itk::Math::FloatAlmostEqual(labelCopy->GetFlatness() , labelObject->GetFlatness()))
      {
      std::cout << "CopyAttributeFrom failed for attribute " << "Flatness" << std::endl;
      status = EXIT_FAILURE;
      }
    if (!itk::Math::FloatAlmostEqual(labelCopy->GetPerimeterOnBorderRatio() , labelObject->GetPerimeterOnBorderRatio()))
      {
  ...
  for (unsigned int n = 0; n < labelMap->GetNumberOfLabelObjects(); n++)
    ...
    if (!itk::Math::FloatAlmostEqual(l->GetPhysicalSize() , accessorPhysicalSize(l)))
      {
    ...
    if (!itk::Math::FloatAlmostEqual(l->GetPerimeterOnBorder() , accessorPerimeterOnBorder(l)))
      {
    ...
    if (!itk::Math::FloatAlmostEqual(l->GetFeretDiameter() , accessorFeretDiameter(l)))
      {
    ...
    if (!itk::Math::FloatAlmostEqual(l->GetElongation() , accessorElongation(l)))
      {
    ...
    if (!itk::Math::FloatAlmostEqual(l->GetPerimeter() , accessorPerimeter(l)))
      {
    ...
    if (!itk::Math::FloatAlmostEqual(l->GetRoundness() , accessorRoundness(l)))
      {
    ...
    if (!itk::Math::FloatAlmostEqual(l->GetEquivalentSphericalRadius() , accessorEquivalentSphericalRadius(l)))
      {
    ...
    if (!itk::Math::FloatAlmostEqual(l->GetEquivalentSphericalPerimeter() , accessorEquivalentSphericalPerimeter(l)))
      {
    ...
    if (!itk::Math::FloatAlmostEqual(l->GetFlatness() , accessorFlatness(l)))
      {
    ...
    if (!itk::Math::FloatAlmostEqual(l->GetPerimeterOnBorderRatio() , accessorPerimeterOnBorderRatio(l)))
      {
