...
int itkCentralDifferenceImageFunctionTest(int, char* [] )
{
  ...
  if( !itk::Math::FloatAlmostEqual(indexOutput[0] , itk::NumericTraits<OutputValueType>::ZeroValue()) )
    {
  ...
  if( !itk::Math::FloatAlmostEqual(indexOutput[1] , itk::NumericTraits<OutputValueType>::ZeroValue()) )
    {
  ...
  if( !itk::Math::FloatAlmostEqual(pointOutput[0] , 0) || pointOutput[1] == 0 )
    {
  ...
  if( !itk::Math::FloatAlmostEqual(directionOnDerivative[0] , -origDerivative[0]) || directionOnDerivative[1] != -origDerivative[1] )
    {
  ...
  if( !itk::Math::FloatAlmostEqual(directionOneNegDerivative[0] , origDerivative[0]) || directionOneNegDerivative[1] != -origDerivative[1] )
    {
  ...
  if( !itk::Math::FloatAlmostEqual(directionSwapDerivative[0] , -origDerivative[1]) || directionSwapDerivative[1] != origDerivative[0] )
    {
  ...
  if( !itk::Math::FloatAlmostEqual(outOfBoundsDerivative[0] , 0) || outOfBoundsDerivative[1] != 0 )
    {
