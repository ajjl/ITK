...
int itkCentralDifferenceImageFunctionTest(int, char* [] )
{
  ...
  if( itk::Math::NotEqualsComparison(indexOutput[0] , itk::NumericTraits<OutputValueType>::ZeroValue()) )
    {
  ...
  if( itk::Math::NotEqualsComparison(indexOutput[1] , itk::NumericTraits<OutputValueType>::ZeroValue()) )
    {
  ...
  if( itk::Math::NotEqualsComparison(directionOnDerivative[0] , -origDerivative[0]) || itk::Math::NotEqualsComparison(directionOnDerivative[1] , -origDerivative[1]) )
    {
  ...
  if( itk::Math::NotEqualsComparison(directionOneNegDerivative[0] , origDerivative[0]) || itk::Math::NotEqualsComparison(directionOneNegDerivative[1] , -origDerivative[1]) )
    {
  ...
  if( itk::Math::NotEqualsComparison(directionSwapDerivative[0] , -origDerivative[1]) || itk::Math::NotEqualsComparison(directionSwapDerivative[1] , origDerivative[0]) )
    {
  ...
  if( itk::Math::NotEqualsComparison(outOfBoundsDerivative[0] , 0) || itk::Math::NotEqualsComparison(outOfBoundsDerivative[1] , 0) )
    {
