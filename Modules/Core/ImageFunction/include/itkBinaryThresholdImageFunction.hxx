...
{
  if ( !itk::Math::FloatAlmostEqual(m_Lower , thresh)
       || !itk::Math::FloatAlmostEqual(m_Upper , NumericTraits< PixelType >::max()) )
    {
    m_Lower = thresh;
    m_Upper = NumericTraits< PixelType >::max();
    this->Modified();
...
{
  if ( !itk::Math::FloatAlmostEqual(m_Lower , NumericTraits< PixelType >::NonpositiveMin())
       || !itk::Math::FloatAlmostEqual(m_Upper , thresh) )
    {
    m_Lower = NumericTraits< PixelType >::NonpositiveMin();
    m_Upper = thresh;
    this->Modified();
...
{
  if ( !itk::Math::FloatAlmostEqual(m_Lower , lower)
       || !itk::Math::FloatAlmostEqual(m_Upper , upper) )
    {
    m_Lower = lower;
    m_Upper = upper;
    this->Modified();
