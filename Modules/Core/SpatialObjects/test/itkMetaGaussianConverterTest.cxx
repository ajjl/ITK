...
int itkMetaGaussianConverterTest(int argc, char* argv[])
{
  ...
  // Check color
  if (!itk::Math::FloatAlmostEqual(newGaussianSpatialObj->GetProperty()->GetRed() , color[0]) ||
      !itk::Math::FloatAlmostEqual(newGaussianSpatialObj->GetProperty()->GetGreen() , color[1]) ||
      !itk::Math::FloatAlmostEqual(newGaussianSpatialObj->GetProperty()->GetBlue() , color[2]) ||
      !itk::Math::FloatAlmostEqual(newGaussianSpatialObj->GetProperty()->GetAlpha() , color[3]))
    {
