...
int itkMetaArrowConverterTest(int ac, char* av[])
{
  ...
  if (!itk::Math::FloatAlmostEqual(newMetaColor[0] , color[0]) || newMetaColor[1] != color[1] ||
      !itk::Math::FloatAlmostEqual(newMetaColor[2] , color[2]) || newMetaColor[3] != color[3])
    {
  ...
  if (!itk::Math::FloatAlmostEqual(newMetaDirection[0] , 0) || newMetaDirection[1] != 0 || newMetaDirection[2] != 0)
    {
  ...
  // check color
  if (!itk::Math::FloatAlmostEqual(newItkArrow->GetProperty()->GetRed() , color[0]) ||
      !itk::Math::FloatAlmostEqual(newItkArrow->GetProperty()->GetGreen() , color[1]) ||
      !itk::Math::FloatAlmostEqual(newItkArrow->GetProperty()->GetBlue() , color[2]) ||
      !itk::Math::FloatAlmostEqual(newItkArrow->GetProperty()->GetAlpha() , color[3]))
    {
  ...
  if (!itk::Math::FloatAlmostEqual(mDirection[0] , 0) || mDirection[1] != 0 || mDirection[2] != 0)
    {
  ...
  // check color
  if (!itk::Math::FloatAlmostEqual(reLoad->GetProperty()->GetRed() , color[0]) ||
      !itk::Math::FloatAlmostEqual(reLoad->GetProperty()->GetGreen() , color[1]) ||
      !itk::Math::FloatAlmostEqual(reLoad->GetProperty()->GetBlue() , color[2]) ||
      !itk::Math::FloatAlmostEqual(reLoad->GetProperty()->GetAlpha() , color[3]))
    {
  ...
  if (!itk::Math::FloatAlmostEqual(reLoadDirectionNorm[0] , 0) || reLoadDirectionNorm[1] != 0 || reLoadDirectionNorm[2] != 0)
    {
