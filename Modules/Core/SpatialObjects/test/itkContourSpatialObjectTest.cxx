...
int itkContourSpatialObjectTest(int, char* [])
{
  ...
  if (!itk::Math::FloatAlmostEqual(contour->GetControlPoints()[0].GetPickedPoint()[0] , pt1.GetPickedPoint()[0]) ||
      !itk::Math::FloatAlmostEqual(contour->GetControlPoints()[0].GetPickedPoint()[1] , pt1.GetPickedPoint()[1]) ||
      !itk::Math::FloatAlmostEqual(contour->GetControlPoints()[1].GetPickedPoint()[0] , pt2.GetPickedPoint()[0]) ||
      !itk::Math::FloatAlmostEqual(contour->GetControlPoints()[1].GetPickedPoint()[1] , pt2.GetPickedPoint()[1]) ||
      !itk::Math::FloatAlmostEqual(contour->GetControlPoints()[2].GetPickedPoint()[0] , pt3.GetPickedPoint()[0]) ||
      !itk::Math::FloatAlmostEqual(contour->GetControlPoints()[2].GetPickedPoint()[1] , pt3.GetPickedPoint()[1]) ||
      !itk::Math::FloatAlmostEqual(contour->GetControlPoints()[3].GetPickedPoint()[0] , pt4.GetPickedPoint()[0]) ||
      !itk::Math::FloatAlmostEqual(contour->GetControlPoints()[3].GetPickedPoint()[1] , pt4.GetPickedPoint()[1]))
    {
  ...
  if (!itk::Math::FloatAlmostEqual(contour->GetControlPoint(0)->GetPickedPoint()[0] , pt1.GetPickedPoint()[0]) ||
      !itk::Math::FloatAlmostEqual(contour->GetControlPoint(0)->GetPickedPoint()[1] , pt1.GetPickedPoint()[1]))
    {
  ...
  // check values of points
  if (!itk::Math::FloatAlmostEqual(contour->GetInterpolatedPoints()[0].GetPosition()[0] , intPt1.GetPosition()[0]) ||
      !itk::Math::FloatAlmostEqual(contour->GetInterpolatedPoints()[0].GetPosition()[1] , intPt1.GetPosition()[1]) ||
      !itk::Math::FloatAlmostEqual(contour->GetInterpolatedPoints()[1].GetPosition()[0] , intPt2.GetPosition()[0]) ||
      !itk::Math::FloatAlmostEqual(contour->GetInterpolatedPoints()[1].GetPosition()[1] , intPt2.GetPosition()[1]))
    {
  ...
  // check retrieval of a single point
  if (!itk::Math::FloatAlmostEqual(contour->GetInterpolatedPoint(0)->GetPosition()[0] , intPt1.GetPosition()[0]) ||
      !itk::Math::FloatAlmostEqual(contour->GetInterpolatedPoint(0)->GetPosition()[1] , intPt1.GetPosition()[1]))
    {
  ...
  double val = -1;
  double* valPtr = &val;
  if (contour->ValueAt(testPoint, *valPtr) || !itk::Math::FloatAlmostEqual(val , contour->GetDefaultOutsideValue()))
    {
