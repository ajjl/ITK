...
int itkMeshSpatialObjectTest(int, char * [] )
{
  ...
  if( (!itk::Math::FloatAlmostEqual(meshSO->GetBoundingBox()->GetBounds()[0] , 0))
   || (!itk::Math::FloatAlmostEqual(meshSO->GetBoundingBox()->GetBounds()[1] , 9))
   || (!itk::Math::FloatAlmostEqual(meshSO->GetBoundingBox()->GetBounds()[2] , 0))
   || (!itk::Math::FloatAlmostEqual(meshSO->GetBoundingBox()->GetBounds()[3] , 9))
   || (!itk::Math::FloatAlmostEqual(meshSO->GetBoundingBox()->GetBounds()[4] , 0))
   || (!itk::Math::FloatAlmostEqual(meshSO->GetBoundingBox()->GetBounds()[5] , 9))
   )
    {
    std::cout<<"[FAILED]"<<std::endl;
    return EXIT_FAILURE;
