...
int itkSpatialObjectToPointSetFilterTest(int, char* [] )
{
  ...
  while( pointItr != pointEnd )
    {
    if( (!itk::Math::FloatAlmostEqual(pointItr.Value()[0] , val))
        || (!itk::Math::FloatAlmostEqual(pointItr.Value()[1] , val))
      )
      {
      std::cout << "[FAILURE]" << std::endl;
      return EXIT_FAILURE;
  ...
  while( pointItr2 != pointEnd2 )
    {
    if( (!itk::Math::FloatAlmostEqual(pointItr2.Value()[0] , val))
        || (!itk::Math::FloatAlmostEqual(pointItr2.Value()[1] , val+1))
        || (!itk::Math::FloatAlmostEqual(pointItr2.Value()[2] , val+2))
      )
      {
