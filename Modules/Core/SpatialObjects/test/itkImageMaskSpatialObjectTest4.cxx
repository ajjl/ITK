...
int Test3dImageMask()
{
  ...
  if ( !itk::Math::FloatAlmostEqual(box1Bounds[0] , 7) || box1Bounds[2] != 7 || box1Bounds[4] != 7 ||
       !itk::Math::FloatAlmostEqual(box1Bounds[1] , 8) || box1Bounds[3] != 8 || box1Bounds[5] != 8 )
  {
  ...
  if(    (!itk::Math::FloatAlmostEqual(maskBounds[0] , 7))
      || (maskBounds[1] != 8.5)
      || (!itk::Math::FloatAlmostEqual(maskBounds[2] , 7))
      || (maskBounds[3] != 8.5)
      || (!itk::Math::FloatAlmostEqual(maskBounds[4] , 7))
      || (maskBounds[5] != 8.5) )
    {
...
int Test2dImageMask()
{
  ...
  BoxType::BoundingBoxType::Pointer box1BoundingBox = box1->GetBoundingBox();
  BoxType::BoundingBoxType::BoundsArrayType box1Bounds = box1BoundingBox->GetBounds();
  if ( !itk::Math::FloatAlmostEqual(box1Bounds[0] , 7) || box1Bounds[2] != 7 ||
       !itk::Math::FloatAlmostEqual(box1Bounds[1] , 8) || box1Bounds[3] != 8 )
  {
    std::cout << "Box1 - Bounding box Error"<<std::endl;
