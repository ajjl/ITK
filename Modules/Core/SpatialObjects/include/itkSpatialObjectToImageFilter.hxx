...
::SetSpacing(const SpacingType & spacing)
{
  ...
  for ( i = 0; i < TOutputImage::ImageDimension; i++ )
    {
    if ( !itk::Math::FloatAlmostEqual((double)spacing[i] , m_Spacing[i]) )
      {
      break;
      }
    }
...
::SetSpacing(const double *spacing)
{
  ...
  for ( i = 0; i < OutputImageDimension; i++ )
    {
    if ( !itk::Math::FloatAlmostEqual(spacing[i] , m_Spacing[i]) )
      {
      break;
      }
    }
...
::SetOrigin(const PointType & origin)
{
  ...
  for ( i = 0; i < OutputImageDimension; i++ )
    {
    if ( !itk::Math::FloatAlmostEqual((double)origin[i] , m_Origin[i]) )
      {
      break;
      }
    }
...
::SetOrigin(const double *origin)
{
  ...
  for ( i = 0; i < OutputImageDimension; i++ )
    {
    if ( !itk::Math::FloatAlmostEqual(origin[i] , m_Origin[i]) )
      {
      break;
      }
    }
...
::GenerateData(void)
{
  ...
  for ( i = 0; i < OutputImageDimension; i++ )
    {
    if ( !itk::Math::FloatAlmostEqual(m_Spacing[i] , 0) )
      {
      specified = true;
      break;
      }
  ...
  while( !it.IsAtEnd() )
    ...
    if ( !itk::Math::FloatAlmostEqual(m_InsideValue , 0) || m_OutsideValue != 0 )
      {
      if ( evaluable )
        {
        if ( m_UseObjectValue )
