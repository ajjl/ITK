...
::Approximate3DNormals()
{
  ...
  while ( it != itEnd )
    ...
    do
      ...
      while ( it2 != m_Points.end() )
        ...
        for ( unsigned int j = 0; j < 3; j++ )
          ...
          if ( itk::Math::EqualsComparisonCaller(d , 0) )
            {
            valid = false;
            break;
            }
        ...
        if ( itk::Math::EqualsComparisonCaller(distance , 0) || !valid )
          {
          i++;
          it2++;
          continue;
      ...
      if ( itk::Math::EqualsComparisonCaller(absvec , 0) )
        {
    ...
    while ( ( itk::Math::EqualsComparisonCaller(absvec , 0) ) && ( badId.size() < m_Points.size() - 1 ) );
