...
int itkSimilarity2DTransformTest(int, char *[] )
{
  ...
  if(
    (!itk::Math::FloatAlmostEqual(jacobian0[0][0] , 10)) || (jacobian0[0][1] != -10) || (jacobian0[0][2] != 0) || (jacobian0[0][3] != 0)
    || (!itk::Math::FloatAlmostEqual(jacobian0[0][4] , 1)) || (jacobian0[0][5] != 0) || (jacobian0[1][0] != 10) || (jacobian0[1][1] != 10)
    || (!itk::Math::FloatAlmostEqual(jacobian0[1][2] , 0) ) || (jacobian0[1][3] != 0) || (jacobian0[1][4] != 0) || (jacobian0[1][5] != 1)
    )
    {
