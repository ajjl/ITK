...
::CalculateTriangleVolume(InputPointType p1, InputPointType p2, InputPointType p3)
{
  ...
  else if ( ( Math::EqualsComparison(absu[0], absu[1]) ) && ( Math::EqualsComparison(absu[0], absu[2]) ) )
    {
    m_Wxyz++;
    }
  else if ( ( Math::EqualsComparison(absu[0], absu[1]) ) && ( absu[0] > absu[2] ) )
    {
    m_Wxy++;
    }
  else if ( ( Math::EqualsComparison(absu[0], absu[2]) ) && ( absu[0] > absu[1] ) )
    {
    m_Wxz++;
    }
  else if ( ( Math::EqualsComparison(absu[1], absu[2]) ) && ( absu[0] < absu[2] ) )
    {
    m_Wyz++;
    }
  else
