...
::CalculateTriangleVolume(InputPointType p1, InputPointType p2, InputPointType p3)
{
  ...
  else if ( ( itk::Math::FloatAlmostEqual(absu[0] , absu[1]) ) && ( absu[0] == absu[2] ) )
    {
    m_Wxyz++;
    }
  else if ( ( itk::Math::FloatAlmostEqual(absu[0] , absu[1]) ) && ( absu[0] > absu[2] ) )
  ...
  else if ( ( itk::Math::FloatAlmostEqual(absu[0] , absu[2]) ) && ( absu[0] > absu[1] ) )
    {
    m_Wxz++;
    }
  else if ( ( itk::Math::FloatAlmostEqual(absu[1] , absu[2]) ) && ( absu[0] < absu[2] ) )
    {
    m_Wyz++;
    }
  else
