...
::CreateMesh()
{
  ...
  while ( !it4.IsAtEnd() )
    ...
    if ( itk::Math::FloatAlmostEqual(it1.Value() , m_ObjectValue) ) { vertexindex += 1; }
    if ( itk::Math::FloatAlmostEqual(it2.Value() , m_ObjectValue) ) { vertexindex += 8; }
    if ( itk::Math::FloatAlmostEqual(it3.Value() , m_ObjectValue) ) { vertexindex += 16; }
    if ( itk::Math::FloatAlmostEqual(it4.Value() , m_ObjectValue) ) { vertexindex += 128; }
    ++it1;
    ++it2;
    ++it3;
    ++it4;
    ...
    if ( ( i % m_ImageWidth < m_ImageWidth - 1 )
      ...
      {
      if ( itk::Math::FloatAlmostEqual(it1.Value() , m_ObjectValue) ) { vertexindex += 2; }
      if ( itk::Math::FloatAlmostEqual(it2.Value() , m_ObjectValue) ) { vertexindex += 4; }
      if ( itk::Math::FloatAlmostEqual(it3.Value() , m_ObjectValue) ) { vertexindex += 32; }
      if ( itk::Math::FloatAlmostEqual(it4.Value() , m_ObjectValue) ) { vertexindex += 64; }
      }
    else
      {
