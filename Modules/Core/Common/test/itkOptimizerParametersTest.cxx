...
bool runTestByType()
{
  ...
  for( itk::SizeValueType i=0; i < params.GetSize(); i++ )
    {
    if( !itk::Math::FloatAlmostEqual(params[i] , paramsCopy[i]) )
      {
  ...
  for( itk::SizeValueType i=0; i < params.GetSize(); i++ )
    {
    if( !itk::Math::FloatAlmostEqual(array[i] , paramsCopy[i]) )
      {
  ...
  for( itk::SizeValueType i=0; i < array.GetSize(); i++ )
    {
    if( !itk::Math::FloatAlmostEqual(paramsArray[i] , array[i]) )
      {
  ...
  for( itk::SizeValueType i=0; i < paramsVnl.GetSize(); i++ )
    {
    if( !itk::Math::FloatAlmostEqual(vector[i] , paramsVnl[i]) )
      {
  ...
  for( int i=0; i < 10; i++)
    {
    if( !itk::Math::FloatAlmostEqual(params[i] , 10-i) )
      {
  ...
  for( itk::SizeValueType i=0; i < params1.GetSize(); i++ )
    {
    if( !itk::Math::FloatAlmostEqual(params1[i] , params2[i]) )
      {
