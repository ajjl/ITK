...
int itkExtractImage3Dto2DTest(int, char* [] )
{
  ...
  // 0 1
  // 1 0
  if (!itk::Math::FloatAlmostEqual(extract->GetOutput()->GetDirection()[0][0] , 0) ||
      !itk::Math::FloatAlmostEqual(extract->GetOutput()->GetDirection()[1][1] , 0) ||
      !itk::Math::FloatAlmostEqual(extract->GetOutput()->GetDirection()[0][1] , 1) ||
      !itk::Math::FloatAlmostEqual(extract->GetOutput()->GetDirection()[1][0] , 1))
  {
    return EXIT_FAILURE;
  }
