...
// scope.
  ...
  if( !itk::Math::FloatAlmostEqual(floatAccumulatorCopy.GetSum() , floatAccumulator.GetSum()) )
    {
  ...
  if( !itk::Math::FloatAlmostEqual(floatAccumulatorCopy2.GetSum() , floatAccumulator.GetSum()) )
    {
  ...
  if( !itk::Math::FloatAlmostEqual(floatAccumulator.GetSum() , itk::NumericTraits< FloatType >::ZeroValue()) )
    {
