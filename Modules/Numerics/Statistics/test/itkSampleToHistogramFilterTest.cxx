...
int itkSampleToHistogramFilterTest( int , char * [] )
{
  ...
  if( !itk::Math::FloatAlmostEqual(recoveredMarginalScaleObject->Get() , marginalScale1) )
    {
  ...
  if( !itk::Math::FloatAlmostEqual(recoveredMarginalScaleObject->Get() , marginalScale2) )
    {
  ...
  for( unsigned int k1 = 0; k1 < numberOfComponents; k1++ )
    {
    if( !itk::Math::FloatAlmostEqual(returnedHistogramBinMinimum[k1] , histogramBinMinimum1[k1]) )
      {
  ...
  for( unsigned int k2 = 0; k2 < numberOfComponents; k2++ )
    {
    if( !itk::Math::FloatAlmostEqual(returnedHistogramBinMinimum[k2] , histogramBinMinimum2[k2]) )
      {
      std::cerr << "Get/Set HistogramSize() failed value consistency test" << std::endl;
      return EXIT_FAILURE;
      }
  ...
  for( unsigned int k3 = 0; k3 < numberOfComponents; k3++ )
    {
    if( !itk::Math::FloatAlmostEqual(returnedHistogramBinMinimum[k3] , histogramBinMinimum1[k3]) )
      {
      std::cerr << "Get/Set HistogramBinMinimum() failed value consistency test" << std::endl;
      return EXIT_FAILURE;
      }
  ...
  for( unsigned int k4 = 0; k4 < numberOfComponents; k4++ )
    {
    if( !itk::Math::FloatAlmostEqual(returnedHistogramBinMinimum[k4] , histogramBinMinimum2[k4]) )
      {
      std::cerr << "Get/Set HistogramBinMinimum() failed value consistency test" << std::endl;
      return EXIT_FAILURE;
      }
  ...
  for( unsigned int k1 = 0; k1 < numberOfComponents; k1++ )
    {
    if( !itk::Math::FloatAlmostEqual(returnedHistogramBinMaximum[k1] , histogramBinMaximum1[k1]) )
      {
  ...
  for( unsigned int k2 = 0; k2 < numberOfComponents; k2++ )
    {
    if( !itk::Math::FloatAlmostEqual(returnedHistogramBinMaximum[k2] , histogramBinMaximum2[k2]) )
      {
      std::cerr << "Get/Set HistogramSize() failed value consistency test" << std::endl;
      return EXIT_FAILURE;
      }
  ...
  for( unsigned int k3 = 0; k3 < numberOfComponents; k3++ )
    {
    if( !itk::Math::FloatAlmostEqual(returnedHistogramBinMaximum[k3] , histogramBinMaximum1[k3]) )
      {
      std::cerr << "Get/Set HistogramBinMaximum() failed value consistency test" << std::endl;
      return EXIT_FAILURE;
      }
  ...
  for( unsigned int k4 = 0; k4 < numberOfComponents; k4++ )
    {
    if( !itk::Math::FloatAlmostEqual(returnedHistogramBinMaximum[k4] , histogramBinMaximum2[k4]) )
      {
      std::cerr << "Get/Set HistogramBinMaximum() failed value consistency test" << std::endl;
      return EXIT_FAILURE;
      }
