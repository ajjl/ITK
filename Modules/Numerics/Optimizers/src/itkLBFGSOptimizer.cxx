...
{
  if ( itk::Math::FloatAlmostEqual(f , m_GradientConvergenceTolerance) )
    {
    return;
    }
...
{
  if ( itk::Math::FloatAlmostEqual(f , m_LineSearchAccuracy) )
    {
    return;
    }
...
{
  if ( itk::Math::FloatAlmostEqual(f , m_DefaultStepLength) )
    {
    return;
    }
