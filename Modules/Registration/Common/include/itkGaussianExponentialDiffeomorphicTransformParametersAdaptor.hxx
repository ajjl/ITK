...
::SetGaussianSmoothingVarianceForTheConstantVelocityField( ScalarType variance )
{
  ...
  if( !itk::Math::FloatAlmostEqual(this->m_GaussianSmoothingVarianceForTheConstantVelocityField , variance) )
    {
...
::SetGaussianSmoothingVarianceForTheUpdateField( ScalarType variance )
{
  ...
  if( !itk::Math::FloatAlmostEqual(this->m_GaussianSmoothingVarianceForTheUpdateField , variance) )
    {
