...
int itkGaussianExponentialDiffeomorphicTransformParametersAdaptorTest(int, char * [] )
{
  ...
  if( !itk::Math::FloatAlmostEqual(adaptor->GetGaussianSmoothingVarianceForTheConstantVelocityField() , transform->GetGaussianSmoothingVarianceForTheConstantVelocityField()) )
    {
