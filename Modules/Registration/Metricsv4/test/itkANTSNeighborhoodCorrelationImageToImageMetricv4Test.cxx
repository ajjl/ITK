...
int itkANTSNeighborhoodCorrelationImageToImageMetricv4Test( int, char ** const )
{
  ...
  if( ! itk::Math::FloatAlmostEqual(valueReturn1, valueReturn2) )
    {
  ...
  if( ! itk::Math::FloatAlmostEqual(valueReturn1, valueReturnSparse) )
    {
  ...
  if( metric->GetNumberOfValidPoints() != 0 || ! itk::Math::FloatAlmostEqual(valueReturn, expectedMetricMax) )
    {
