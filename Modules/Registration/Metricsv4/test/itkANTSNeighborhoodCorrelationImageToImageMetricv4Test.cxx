...
int itkANTSNeighborhoodCorrelationImageToImageMetricv4Test( int, char ** const )
{
  ...
  if( itk::Math::NotEqualsComparison( valueReturn1, valueReturn2 ) )
    {
  ...
  if( itk::Math::NotEqualsComparison( valueReturn1, valueReturnSparse ) )
    {
  ...
  if( itk::Math::NotEqualsComparison( metric->GetNumberOfValidPoints(), 0 ) || itk::Math::NotEqualsComparison( valueReturn, expectedMetricMax ) )
    {
