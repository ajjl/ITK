...
void testStringToolsWithBasicType()
{
  ...
  // for double
    ...
    // check result
    if ( !itk::Math::FloatAlmostEqual(dataIn , dataOut) )
      {
...
void testStringToolsWithStdVector()
{
  ...
  for ( size_t i = 0; i < dataIn.size(); i++ )
    {
    if ( !itk::Math::FloatAlmostEqual(dataIn[i] , dataOut1[i]) )
      {
  ...
  for ( size_t i = 0; i < dataOut2.size(); i++ )
    {
    if ( !itk::Math::FloatAlmostEqual(dataIn[i] , dataOut2[i]) )
      {
  ...
  for ( size_t i = 0; i < 5; i++ )
    {
    if ( !itk::Math::FloatAlmostEqual(dataIn[i] , dataOut3[i]) )
      {
  ...
  for ( size_t i = 0; i < 5; i++ )
    {
    if ( !itk::Math::FloatAlmostEqual(dataIn[i] , dataOut4[i]) )
      {
