...
int itkGDCMImagePositionPatientTest( int argc, char* argv[] )
{
  ...
  if ((!itk::Math::FloatAlmostEqual(readerOrigin3D[0] , origin3D[0])) ||
      (!itk::Math::FloatAlmostEqual(readerOrigin3D[1] , origin3D[1])) ||
      (!itk::Math::FloatAlmostEqual(readerOrigin3D[2] , origin3D[2])))
    {
