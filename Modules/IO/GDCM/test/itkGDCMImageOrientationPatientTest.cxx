...
int itkGDCMImageOrientationPatientTest( int argc, char* argv[] )
{
  ...
  if ((itk::Math::NotEqualsComparison(readerDirection3D[0][0] , direction3D[0][0])) ||
      (itk::Math::NotEqualsComparison(readerDirection3D[1][0] , direction3D[1][0])) ||
      (itk::Math::NotEqualsComparison(readerDirection3D[2][0] , direction3D[2][0])) ||
      (itk::Math::NotEqualsComparison(readerDirection3D[0][1] , direction3D[0][1])) ||
      (itk::Math::NotEqualsComparison(readerDirection3D[1][1] , direction3D[1][1])) ||
      (itk::Math::NotEqualsComparison(readerDirection3D[2][1] , direction3D[2][1]))
      )
    {
